...
QueuePair * QueuePairFactory::acceptIncomingConnection(bool useSharedQueue, void *userData, uint32_t userDataSizeInBytes) {
	...
	QueuePair *queuePair = new QueuePair(this->context, useSharedQueue);
...
QueuePair * QueuePairFactory::connectToRemoteHost(const char* hostAddress, uint16_t port, bool useSharedQueue, void *userData, uint32_t userDataSizeInBytes) {
...
QueuePair* QueuePairFactory::createLoopback(bool useSharedQueue, void *userData, uint32_t userDataSizeInBytes) {
